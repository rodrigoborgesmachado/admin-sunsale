  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="sidebar__menu">
        ...
        {isAdmin && <a href="/categoriaalimentos" className={pathSegments[0] === 'categoriaalimentos' ? "sidebar__menu-item sidebar__menu-item-selected" : "sidebar__menu-item"}><CarrotIcon color='white'/>Categoria Alimentos</a>}
        ...
        {isAdmin && <a href="/questoes" className={pathSegments[0] === 'questoes' ? "sidebar__menu-item sidebar__menu-item-selected" : "sidebar__menu-item"}><BasketIcon color='white'/>Questões</a>}
        {isAdmin && <a href="/questoesavaliacao" className={pathSegments[0] === 'questoesavaliacao' ? "sidebar__menu-item sidebar__menu-item-selected" : "sidebar__menu-item"}><BasketIcon color='white'/>Questões Avaliação</a>}
        {isAdmin && <a href="/recuperasenha" className={pathSegments[0] === 'recuperasenha' ? "sidebar__menu-item sidebar__menu-item-selected" : "sidebar__menu-item"}><BasketIcon color='white'/>Rec. Senha</a>}
        {isAdmin && <a href="/recuperasenhacrudforms" className={pathSegments[0] === 'recuperasenhacrudforms' ? "sidebar__menu-item sidebar__menu-item-selected" : "sidebar__menu-item"}><BasketIcon color='white'/>Rec. Senha Crudf</a>}
        {isAdmin && <a href="/respostasavaliacoes" className={pathSegments[0] === 'respostasavaliacoes' ? "sidebar__menu-item sidebar__menu-item-selected" : "sidebar__menu-item"}><BasketIcon color='white'/>Respostas Avaliações</a>}
        {isAdmin && <a href="/respostasquestoes" className={pathSegments[0] === 'respostasquestoes' ? "sidebar__menu-item sidebar__menu-item-selected" : "sidebar__menu-item"}><BasketIcon color='white'/>Respostas Questões</a>}
        {isAdmin && <a href="/respostasusuarios" className={pathSegments[0] === 'respostasusuarios' ? "sidebar__menu-item sidebar__menu-item-selected" : "sidebar__menu-item"}><BasketIcon color='white'/>Respostas Usuários</a>}
        {isAdmin && <a href="/resultadossoletrando" className={pathSegments[0] === 'resultadossoletrando' ? "sidebar__menu-item sidebar__menu-item-selected" : "sidebar__menu-item"}><BasketIcon color='white'/>Resultados Soletrando</a>}
        ...
        {isAdmin && <a href="/tipoperfil" className={pathSegments[0] === 'tipoperfil' ? "sidebar__menu-item sidebar__menu-item-selected" : "sidebar__menu-item"}><BasketIcon color='white'/>Tipo Perfil</a>}
        {isAdmin && <a href="/tipopostagem" className={pathSegments[0] === 'tipopostagem' ? "sidebar__menu-item sidebar__menu-item-selected" : "sidebar__menu-item"}><BasketIcon color='white'/>Tipo Postagem</a>}
        {isAdmin && <a href="/tipoprova" className={pathSegments[0] === 'tipoprova' ? "sidebar__menu-item sidebar__menu-item-selected" : "sidebar__menu-item"}><BasketIcon color='white'/>Tipo Prova</a>}
        {isAdmin && <a href="/tipoprovaassociado" className={pathSegments[0] === 'tipoprovaassociado' ? "sidebar__menu-item sidebar__menu-item-selected" : "sidebar__menu-item"}><BasketIcon color='white'/>Tipo Prova Assoc.</a>}
        ...
        {isAdmin && <a href="/usuarioscrudforms" className={pathSegments[0] === 'usuarioscrudforms' ? "sidebar__menu-item sidebar__menu-item-selected" : "sidebar__menu-item"}><BasketIcon color='white'/>Usuarios Crudforms</a>}
        {isAdmin && <a href="/veiculosfordev" className={pathSegments[0] === 'veiculosfordev' ? "sidebar__menu-item sidebar__menu-item-selected" : "sidebar__menu-item"}><BasketIcon color='white'/>Veiculos For Dev</a>}
        {isAdmin && <a href="/verboconjugado" className={pathSegments[0] === 'verboconjugado' ? "sidebar__menu-item sidebar__menu-item-selected" : "sidebar__menu-item"}><BasketIcon color='white'/>Verbo Conjugado</a>}
        ...
        {isAdmin && <a href="/verificacaousuario" className={pathSegments[0] === 'verificacaousuario' ? "sidebar__menu-item sidebar__menu-item-selected" : "sidebar__menu-item"}><BasketIcon color='white'/>Verificação Usuário</a>}
