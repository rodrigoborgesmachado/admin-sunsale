            ...
            <table className="admin-table">
                <thead>
                    <tr>
                        ...
                        <th>IdUsuario</th>
                        <th>IdProva</th>
                        <th>QuantidadeQuestoes</th>
                        <th>QuantidadeCertas</th>
                        <th>Tempo</th>
                    </tr>
                </thead>
                <tbody>
                {items.map((item) => (
                    <tr key={item.Id}>
                        ...
                        <td data-label='QuantidadeQuestoes'><span>{item.QuantidadeQuestoes}</span></td>
                        <td data-label='QuantidadeCertas'><span>{item.QuantidadeCertas}</span></td>
