...
import './CartaocreditodevtoolsListPage.css';
import cartaocreditodevtoolsApi from '../../../services/apiServices/cartaocreditodevtoolsApi';
...
const CartaocreditodevtoolsListPage = () => {
    ...
    useEffect(() => {
        const fetchItems = async () => {
            ...
            try {
                const response = await cartaocreditodevtoolsApi.getPaginated({ page, quantity, orderBy, term: searchTerm, startDate, endDate, include: "" });
    ...
    const exportFunction = async ({term}) => {
        try {
            dispatch(setLoading(true));
            const response = await cartaocreditodevtoolsApi.export({ term: term, startDate, endDate });
...
export default CartaocreditodevtoolsListPage;
