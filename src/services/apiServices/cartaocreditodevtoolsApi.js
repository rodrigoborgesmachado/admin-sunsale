...
const cartaocreditodevtoolsApi = {
    /**
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Cartaocreditodevtools', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Cartaocreditodevtools/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Cartaocreditodevtools', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Cartaocreditodevtools', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Cartaocreditodevtools', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Cartaocreditodevtools/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Cartaocreditodevtools/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Cartaocreditodevtools/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
...
export default cartaocreditodevtoolsApi;
