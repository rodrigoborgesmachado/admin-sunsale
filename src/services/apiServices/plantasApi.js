...
const plantasApi = {
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Plantas/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Plantas', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Plantas', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Plantas', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Plantas/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Plantas/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Plantas/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
