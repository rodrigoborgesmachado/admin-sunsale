...
const avaliacaoApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Avaliacao', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Avaliacao/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Avaliacao', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Avaliacao', itemsData);
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Avaliacao/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Avaliacao/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Avaliacao/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
