...
const recuperasenhaApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Recuperasenha', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Recuperasenha/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Recuperasenha', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Recuperasenha', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Recuperasenha', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Recuperasenha/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Recuperasenha/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Recuperasenha/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
...
export default recuperasenhaApi;
