...
const imagensbiomaApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Imagensbioma', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Imagensbioma/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Imagensbioma', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Imagensbioma', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Imagensbioma', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Imagensbioma/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Imagensbioma/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Imagensbioma/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
...
export default imagensbiomaApi;
