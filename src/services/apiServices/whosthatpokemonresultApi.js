...
const whosthatpokemonresultApi = {
    /**
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Whosthatpokemonresult', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Whosthatpokemonresult/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Whosthatpokemonresult', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Whosthatpokemonresult', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Whosthatpokemonresult', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Whosthatpokemonresult/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Whosthatpokemonresult/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Whosthatpokemonresult/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
...
export default whosthatpokemonresultApi;
