...
const savedresultswppApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Savedresultswpp', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Savedresultswpp/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Savedresultswpp', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Savedresultswpp', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Savedresultswpp', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Savedresultswpp/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Savedresultswpp/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Savedresultswpp/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
...
export default savedresultswppApi;
