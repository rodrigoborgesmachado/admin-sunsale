...
const verbosApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Verbos', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Verbos/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Verbos', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Verbos', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Verbos', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Verbos/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Verbos/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Verbos/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
