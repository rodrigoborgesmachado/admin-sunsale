...
const comentariosquestoesApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Comentariosquestoes', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Comentariosquestoes/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Comentariosquestoes', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Comentariosquestoes', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Comentariosquestoes', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Comentariosquestoes/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Comentariosquestoes/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Comentariosquestoes/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
...
export default comentariosquestoesApi;
