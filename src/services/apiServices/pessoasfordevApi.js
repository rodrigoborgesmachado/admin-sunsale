...
const pessoasfordevApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Pessoasfordev', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Pessoasfordev/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Pessoasfordev', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Pessoasfordev', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Pessoasfordev', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Pessoasfordev/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Pessoasfordev/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Pessoasfordev/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
...
export default pessoasfordevApi;
