...
const biomasApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Biomas', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Biomas/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Biomas', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Biomas', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Biomas', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Biomas/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Biomas/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Biomas/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
