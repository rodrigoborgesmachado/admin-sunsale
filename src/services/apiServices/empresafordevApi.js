...
const empresafordevApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Empresafordev', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Empresafordev/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Empresafordev', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Empresafordev', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Empresafordev', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Empresafordev/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Empresafordev/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Empresafordev/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
...
export default empresafordevApi;
