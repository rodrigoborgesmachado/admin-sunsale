...
const questoesApi = {
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Questoes/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Questoes', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Questoes', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Questoes', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Questoes/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Questoes/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Questoes/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
