...
const veiculosfordevApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Veiculosfordev', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Veiculosfordev/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Veiculosfordev', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Veiculosfordev', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Veiculosfordev', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Veiculosfordev/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Veiculosfordev/pagged', { params });
            return response.data;
        } catch (error) {
