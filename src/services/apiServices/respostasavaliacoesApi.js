...
const respostasavaliacoesApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Respostasavaliacoes', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Respostasavaliacoes/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Respostasavaliacoes', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Respostasavaliacoes', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Respostasavaliacoes', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Respostasavaliacoes/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Respostasavaliacoes/pagged', { params });
            return response.data;
        } catch (error) {
