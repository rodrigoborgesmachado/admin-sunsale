...
const tipoprovaassociadoApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Tipoprovaassociado', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Tipoprovaassociado/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Tipoprovaassociado', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Tipoprovaassociado', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Tipoprovaassociado', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Tipoprovaassociado/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Tipoprovaassociado/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Tipoprovaassociado/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
...
export default tipoprovaassociadoApi;
