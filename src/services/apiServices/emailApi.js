...
const emailApi = {
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Email/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Email', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Email', itemsData);
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Email/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Email/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Email/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
