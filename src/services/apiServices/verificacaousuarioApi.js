...
const verificacaousuarioApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Verificacaousuario', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Verificacaousuario/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Verificacaousuario', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Verificacaousuario', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Verificacaousuario', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Verificacaousuario/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Verificacaousuario/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Verificacaousuario/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
...
export default verificacaousuarioApi;
