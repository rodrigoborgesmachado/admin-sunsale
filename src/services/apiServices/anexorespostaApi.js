...
const anexorespostaApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Anexoresposta', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Anexoresposta/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Anexoresposta', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Anexoresposta', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Anexoresposta', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Anexoresposta/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Anexoresposta/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Anexoresposta/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
...
export default anexorespostaApi;
