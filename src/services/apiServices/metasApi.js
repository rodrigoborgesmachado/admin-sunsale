...
const metasApi = {
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Metas/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Metas', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Metas', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Metas', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Metas/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Metas/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
