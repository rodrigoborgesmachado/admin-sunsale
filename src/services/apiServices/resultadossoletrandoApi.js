...
const resultadossoletrandoApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Resultadossoletrando', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Resultadossoletrando/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Resultadossoletrando', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Resultadossoletrando', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Resultadossoletrando', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Resultadossoletrando/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Resultadossoletrando/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Resultadossoletrando/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
...
export default resultadossoletrandoApi;
