...
const verboconjugadoApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Verboconjugado', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Verboconjugado/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Verboconjugado', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Verboconjugado', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Verboconjugado', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Verboconjugado/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Verboconjugado/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Verboconjugado/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
...
export default verboconjugadoApi;
