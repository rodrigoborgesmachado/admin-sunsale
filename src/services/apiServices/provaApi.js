...
const provaApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Prova', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Prova/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Prova', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Prova', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Prova', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Prova/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Prova/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Prova/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
