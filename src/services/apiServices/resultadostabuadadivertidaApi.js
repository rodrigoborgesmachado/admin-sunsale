...
const resultadostabuadadivertidaApi = {
    /**
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Resultadostabuadadivertida', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Resultadostabuadadivertida/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Resultadostabuadadivertida', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Resultadostabuadadivertida', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Resultadostabuadadivertida', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Resultadostabuadadivertida/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Resultadostabuadadivertida/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Resultadostabuadadivertida/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
...
export default resultadostabuadadivertidaApi;
