...
const tipopostagemApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Tipopostagem', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Tipopostagem/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Tipopostagem', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Tipopostagem', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Tipopostagem', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Tipopostagem/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Tipopostagem/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Tipopostagem/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
...
export default tipopostagemApi;
