...
const pesosApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Pesos', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Pesos/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Pesos', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Pesos', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Pesos', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Pesos/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Pesos/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Pesos/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
