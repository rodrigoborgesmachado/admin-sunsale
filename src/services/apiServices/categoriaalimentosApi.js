...
const categoriaalimentosApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Categoriaalimentos', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Categoriaalimentos/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Categoriaalimentos', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Categoriaalimentos', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Categoriaalimentos', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Categoriaalimentos/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Categoriaalimentos/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Categoriaalimentos/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
...
export default categoriaalimentosApi;
