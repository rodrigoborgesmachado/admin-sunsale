...
const licencassunsaleproApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Licencassunsalepro', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Licencassunsalepro/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Licencassunsalepro', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Licencassunsalepro', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Licencassunsalepro', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Licencassunsalepro/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Licencassunsalepro/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Licencassunsalepro/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
...
export default licencassunsaleproApi;
