...
const crudformsinstaladorApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Crudformsinstalador', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Crudformsinstalador/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Crudformsinstalador', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Crudformsinstalador', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Crudformsinstalador', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Crudformsinstalador/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Crudformsinstalador/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Crudformsinstalador/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
...
export default crudformsinstaladorApi;
