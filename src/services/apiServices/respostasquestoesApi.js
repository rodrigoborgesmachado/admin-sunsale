...
const respostasquestoesApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Respostasquestoes', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Respostasquestoes/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Respostasquestoes', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Respostasquestoes', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Respostasquestoes', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Respostasquestoes/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Respostasquestoes/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Respostasquestoes/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
...
export default respostasquestoesApi;
