...
const acaousuarioApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Acaousuario', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Acaousuario/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Acaousuario', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Acaousuario', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Acaousuario', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Acaousuario/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Acaousuario/pagged', { params });
            return response.data;
        } catch (error) {
