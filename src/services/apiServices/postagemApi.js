...
const postagemApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Postagem', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Postagem/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Postagem', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Postagem', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Postagem', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Postagem/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Postagem/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Postagem/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
