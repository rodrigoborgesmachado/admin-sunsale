...
const usuariosApi = {
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Usuarios/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Usuarios', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Usuarios', itemsData);
            return response.data;
        } catch (error) {
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Usuarios/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Usuarios/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
