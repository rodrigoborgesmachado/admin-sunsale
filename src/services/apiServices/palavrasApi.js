...
const palavrasApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Palavras', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Palavras/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Palavras', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Palavras', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Palavras', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Palavras/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Palavras/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Palavras/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
