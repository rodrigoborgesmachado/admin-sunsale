...
const tipoprovaApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Tipoprova', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Tipoprova/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Tipoprova', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Tipoprova', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Tipoprova', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Tipoprova/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Tipoprova/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Tipoprova/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
