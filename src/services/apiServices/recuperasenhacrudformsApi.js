...
const recuperasenhacrudformsApi = {
    /**
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Recuperasenhacrudforms', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Recuperasenhacrudforms/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Recuperasenhacrudforms', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Recuperasenhacrudforms', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Recuperasenhacrudforms', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Recuperasenhacrudforms/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Recuperasenhacrudforms/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Recuperasenhacrudforms/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
...
export default recuperasenhacrudformsApi;
