...
const simuladosApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Simulados', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Simulados/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Simulados', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Simulados', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Simulados', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Simulados/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Simulados/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Simulados/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
