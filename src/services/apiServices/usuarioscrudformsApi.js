...
const usuarioscrudformsApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Usuarioscrudforms', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Usuarioscrudforms/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Usuarioscrudforms', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Usuarioscrudforms', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Usuarioscrudforms', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Usuarioscrudforms/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Usuarioscrudforms/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Usuarioscrudforms/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
...
export default usuarioscrudformsApi;
