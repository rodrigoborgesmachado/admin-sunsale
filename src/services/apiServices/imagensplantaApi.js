...
const imagensplantaApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Imagensplanta', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Imagensplanta/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Imagensplanta', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Imagensplanta', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Imagensplanta', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Imagensplanta/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Imagensplanta/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Imagensplanta/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
...
export default imagensplantaApi;
