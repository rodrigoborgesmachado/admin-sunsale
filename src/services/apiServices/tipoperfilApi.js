...
const tipoperfilApi = {
    ...
    getAll: async (params = {}) => {
        try {
            const response = await api.get('/Tipoperfil', { params });
    ...
    getByCode: async (code, params = {}) => {
        try {
            const response = await api.get(`/Tipoperfil/${code}`, { params });
            return response.data;
        } catch (error) {
    ...
    create: async (itemsData) => {
        try {
            const response = await api.post('/Tipoperfil', itemsData);
            return response.data;
        } catch (error) {
    ...
    update: async (itemsData) => {
        try {
            const response = await api.put('/Tipoperfil', itemsData);
            return response.data;
        } catch (error) {
    ...
    delete: async (itemsCode) => {
        try {
            const response = await api.delete('/Tipoperfil', {
                data: { code: itemsCode },
            });
            return response.data;
        } catch (error) {
    ...
    export: async (params) => {
        try {
            const response = await api.get('/Tipoperfil/export', {
                params,
    ...
    getPaginated: async (params) => {
        try {
            const response = await api.get('/Tipoperfil/pagged', { params });
            return response.data;
        } catch (error) {
    ...
    */
    updateStatus: async (params) => {
        try {
            const response = await api.put('/Tipoperfil/UpdateStatus', {}, {
                params
            });
            return response.data;
        } catch (error) {
